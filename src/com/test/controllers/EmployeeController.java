...
//	@RequestMapping(value="/getEmpName.html" , method = RequestMethod.GET)
	public @ResponseBody String getEmployeeName(@RequestParam(value="id", required=true, defaultValue="1") String id) throws JsonGenerationException, JsonMappingException, IOException{
